...
Refer to the [Test](/developer-guide/test) documentation for fixture patterns and state-isolation requirements.
...
1. Place the constant in the appropriate namespace, such as `dl.*` or `&lt;project&gt;.*` (refer to the [Semantic Conventions](/design/semantic-conventions) documentation).
...
Refer to [Build the Documentation](/developer-guide/build-the-documentation) for local preview, authoring, versioning, and troubleshooting details.
