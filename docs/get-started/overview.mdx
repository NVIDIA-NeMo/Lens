...
- [Install NeMo Lens](/get-started/installation)
- Follow the [Quickstart](/get-started/quickstart) guide to instrument a minimal script
- Read the [User Guide](/user-guide/configuration) for details on each feature
