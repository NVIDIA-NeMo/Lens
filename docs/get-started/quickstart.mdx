...
- [Configuration](/user-guide/configuration) for the full env var reference and `NemoLensConfig` options
- [Instrumentation Primitives](/user-guide/instrumentation-primitives) for guidance on when to use each primitive
- [Span Groups](/user-guide/span-groups) for information on how to control granularity
- [Observability Stack](/backends-demo-stack/demo-stack) to run Jaeger, Prometheus, and Grafana locally
