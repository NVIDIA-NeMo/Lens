...
- [Send telemetry to a file](/backends-demo-stack/send-telemetry-to-a-backend#file)
- [Send telemetry to W&B Weave](/backends-demo-stack/send-telemetry-to-a-backend#wb-weave)
- [Send telemetry to Honeycomb](/backends-demo-stack/send-telemetry-to-a-backend#honeycomb)
- [Send telemetry to an OTel Collector](/backends-demo-stack/send-telemetry-to-a-backend#otel-collector)

For trying things out locally, see the [demo docker-compose stack](/backends-demo-stack/demo-stack) (proof of concept, not for production).
