...
Refer to the [Testing](testing.md) documentation for fixture patterns and state-isolation requirements.
...
1. Place the constant in the appropriate namespace, such as `dl.*` or `<project>.*` (refer to the [Semantic Conventions](../design/semconv.md) documentation).
...
The documentation source is located in the `docs/` directory and is built using Sphinx, the MyST parser, and the NVIDIA theme.
...
Refer to the [Build the Documentation](building-docs.md) to understand the full workflow, including build commands, iteration patterns, writing conventions, and debugging build failures.
