...
See [Span Groups](../user-guide/span-groups.mdx) for how groups work at runtime; this page is for library authors.
...
- [ ] Entry added to [Span Groups](../user-guide/span-groups.mdx).
...
See [Test](../developer/testing.mdx) for fixture conventions. A typical new-group test:
