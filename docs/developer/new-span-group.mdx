...
See [Span Groups](/user-guide/span-groups) for how groups work at runtime; this page is for library authors.
...
- [ ] Entry added to [Span Groups](/user-guide/span-groups).
...
See [Test](/developer-guide/test) for fixture conventions. A typical new-group test:
